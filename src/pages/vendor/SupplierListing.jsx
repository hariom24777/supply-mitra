      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col gap-4 md:flex-row md:justify-between md:items-center mb-6">
          ...
          <input
            ...
            className="p-2 border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-600 rounded w-full md:w-1/2"
          />
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredSuppliers.map((supplier) => (
              ...
              >
                ...
                <button
                  className="mt-4 px-4 py-2 bg-blue-600 text-white rounded text-sm hover:bg-blue-700 transition-all duration-300 cursor-pointer"
                  onClick={() =>
