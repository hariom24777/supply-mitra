...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 px-4 py-8">
      ...
      {/* Main Card */}
      <div className="py-12 bg-white shadow-2xl rounded-2xl overflow-hidden flex flex-col md:flex-row w-full max-w-5xl">
        {/* Left - SVG Illustration */}
        <div className="w-full md:w-1/2 p-6 flex items-center justify-center bg-blue-50">
          <img
            src="/landing-page-illustration.svg" // Replace with your SVG
            alt="Role Selection"
